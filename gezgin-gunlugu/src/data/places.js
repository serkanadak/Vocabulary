...
export const PLACES = [
  ...
  { id: 'sirmione', name: 'Sirmione', city: 'Sirmione', country: 'İtalya', lat: 45.4949, lng: 10.606, aliases: ['sirmione', 'garda sirmione'], summary: 'Garda Gölü’ne uzanan ince yarımadadaki Sirmione; su üstüne kurulu Scaliger Kalesi, gölün ucundaki Roma villası Catullus Mağaraları ve termal kaplıcalarıyla ünlü bir tatil kasabasıdır.', sources: ['Italia.it — Sirmione', 'Lonely Planet — Sirmione'] },
  // --- İtalya ara/geçiş durakları ---
  { id: 'verona', name: 'Verona', city: 'Verona', country: 'İtalya', lat: 45.4384, lng: 10.9916, aliases: ['verona'], summary: 'Romeo ve Juliet’in şehri Verona; iyi korunmuş Roma Arenası (opera festivali), Juliet’in balkonu ve Adige kıyısı meydanlarıyla UNESCO korumalı tarihî merkeze sahiptir.', sources: ['UNESCO World Heritage List — City of Verona', 'Italia.it — Verona'] },
  { id: 'padova', name: 'Padova', city: 'Padova', country: 'İtalya', lat: 45.4064, lng: 11.8768, aliases: ['padova', 'padua'], summary: 'Venedik’e yakın Padova; Giotto’nun freskleriyle Scrovegni Şapeli (UNESCO), Aziz Antonio Bazilikası ve dünyanın en eski botanik bahçelerinden biriyle bilinir.', sources: ['UNESCO World Heritage List — Padua’s fourteenth-century fresco cycles', 'Italia.it — Padova'] },
  { id: 'vicenza', name: 'Vicenza', city: 'Vicenza', country: 'İtalya', lat: 45.5455, lng: 11.5354, aliases: ['vicenza'], summary: 'Mimar Palladio’nun kenti Vicenza; Teatro Olimpico, Basilica Palladiana ve villalarıyla bir açık hava Rönesans mimarisi müzesidir (UNESCO).', sources: ['UNESCO World Heritage List — City of Vicenza and the Palladian Villas of the Veneto'] },
  { id: 'bologna', name: 'Bologna', city: 'Bologna', country: 'İtalya', lat: 44.4949, lng: 11.3426, aliases: ['bologna'], summary: 'Kemer altı yollarıyla (portici, UNESCO) ünlü Bologna; iki eğik kulesi, Piazza Maggiore’si, dünyanın en eski üniversitesi ve zengin mutfağıyla canlı bir öğrenci kentidir.', sources: ['UNESCO World Heritage List — The Porticoes of Bologna', 'Italia.it — Bologna'] },
  { id: 'bergamo', name: 'Bergamo', city: 'Bergamo', country: 'İtalya', lat: 45.6983, lng: 9.6773, aliases: ['bergamo'], summary: 'Milano’ya yakın Bergamo; Venedik surlarıyla çevrili tepedeki Città Alta (Üst Şehir), fünikülerleri ve Piazza Vecchia’sıyla şirin bir duraktır.', sources: ['Italia.it — Bergamo'] },
  { id: 'como', name: 'Como Gölü', city: 'Como', country: 'İtalya', lat: 45.8081, lng: 9.0852, aliases: ['como', 'como gölü', 'lago di como', 'lake como', 'bellagio'], summary: 'Alpler eteğindeki Como Gölü; villaları, bahçeleri ve Bellagio gibi kasabalarıyla İtalya’nın en zarif göl bölgelerinden biridir.', sources: ['Italia.it — Lago di Como'] },
  { id: 'bolzano', name: 'Bolzano', city: 'Bolzano', country: 'İtalya', lat: 46.4983, lng: 11.3548, aliases: ['bolzano', 'bozen'], summary: 'Dolomitler’in kapısı Bolzano; buz adamı Ötzi’nin sergilendiği arkeoloji müzesi ve Alp-İtalyan kültürünün buluştuğu çarşısıyla bilinir.', sources: ['Italia.it — Bolzano'] },
  { id: 'trento', name: 'Trento', city: 'Trento', country: 'İtalya', lat: 46.0679, lng: 11.1211, aliases: ['trento', 'trent'], summary: 'Dolomitler eteğindeki Trento; freskli sarayı Castello del Buonconsiglio, Konsil tarihini taşıyan katedrali ve Alp çevresiyle bilinir.', sources: ['Italia.it — Trento'] },
  { id: 'siena', name: 'Siena', city: 'Siena', country: 'İtalya', lat: 43.3188, lng: 11.3308, aliases: ['siena'], summary: 'Toskana’nın ortaçağ incisi Siena; deniz kabuğu biçimli Piazza del Campo’su, Palio at yarışı ve alacalı mermer katedraliyle bütünüyle UNESCO Dünya Mirasıdır.', sources: ['UNESCO World Heritage List — Historic Centre of Siena'] },
  { id: 'sangimignano', name: 'San Gimignano', city: 'San Gimignano', country: 'İtalya', lat: 43.4674, lng: 11.0431, aliases: ['san gimignano', 'sangimignano'], summary: '“Ortaçağın Manhattan’ı” San Gimignano; ovaya yükselen taş kuleleri ve Vernaccia şarabıyla ünlü UNESCO korumalı Toskana kasabasıdır.', sources: ['UNESCO World Heritage List — Historic Centre of San Gimignano'] },
  { id: 'lucca', name: 'Lucca', city: 'Lucca', country: 'İtalya', lat: 43.843, lng: 10.5027, aliases: ['lucca'], summary: 'Rönesans surlarının üstünde bisiklet sürülen Lucca; yuvarlak Anfiteatro Meydanı, kuleleri ve Puccini’nin doğduğu şehir olmasıyla sevilir.', sources: ['Italia.it — Lucca'] },
  { id: 'cinqueterre', name: 'Cinque Terre', city: 'Cinque Terre', country: 'İtalya', lat: 44.1069, lng: 9.7292, aliases: ['cinque terre', 'cinqueterre', 'riomaggiore', 'vernazza', 'manarola'], summary: 'Ligurya kıyısındaki beş renkli balıkçı köyü (Monterosso, Vernazza, Corniglia, Manarola, Riomaggiore); uçurum patikaları, bağ terasları ve UNESCO korumasıyla ünlüdür.', sources: ['UNESCO World Heritage List — Portovenere, Cinque Terre'] },
  { id: 'rimini', name: 'Rimini', city: 'Rimini', country: 'İtalya', lat: 44.0594, lng: 12.5683, aliases: ['rimini'], summary: 'Adriyatik sahil kenti Rimini; uzun plajları, Roma dönemi Tiberius Köprüsü ve Augustus Takı ile San Marino’ya açılan konumuyla popüler bir duraktır.', sources: ['Italia.it — Rimini'] },
  ...
  { id: 'regensburg', name: 'Regensburg', city: 'Regensburg', country: 'Almanya', lat: 49.0134, lng: 12.1016, aliases: ['regensburg'], summary: 'Tuna kıyısındaki Regensburg; savaşlardan sağ çıkmış ortaçağ eski şehri (UNESCO), Taş Köprüsü ve katedraliyle Bavyera’nın en iyi korunan kentlerindendir.', sources: ['UNESCO World Heritage List — Old town of Regensburg with Stadtamhof'] },
  { id: 'nurnberg', name: 'Nürnberg', city: 'Nürnberg', country: 'Almanya', lat: 49.4521, lng: 11.0767, aliases: ['nurnberg', 'nürnberg', 'nuremberg'], summary: 'Nürnberg; İmparatorluk Kalesi ve yarım ahşap eski şehri, ünlü Noel pazarı ve II. Dünya Savaşı belgeleme merkeziyle tarihî bir Bavyera kentidir.', sources: ['Germany.travel — Nuremberg'] },
  { id: 'wurzburg', name: 'Würzburg', city: 'Würzburg', country: 'Almanya', lat: 49.7913, lng: 9.9534, aliases: ['wurzburg', 'würzburg'], summary: 'Romantik Yol’un başındaki Würzburg; Tiepolo tavan freskli görkemli Residenz Sarayı (UNESCO), Marienberg Kalesi ve şarap bağlarıyla bilinir.', sources: ['UNESCO World Heritage List — Würzburg Residence'] },
  { id: 'rothenburg', name: 'Rothenburg ob der Tauber', city: 'Rothenburg', country: 'Almanya', lat: 49.3775, lng: 10.1789, aliases: ['rothenburg', 'rothenburg ob der tauber'], summary: 'Romantik Yol’un simgesi Rothenburg; tümüyle surlarla çevrili, yarım ahşap evli masalsı ortaçağ kasabasıdır.', sources: ['Germany.travel — Rothenburg ob der Tauber'] },
  { id: 'fussen', name: 'Füssen (Neuschwanstein)', city: 'Füssen', country: 'Almanya', lat: 47.5716, lng: 10.7017, aliases: ['fussen', 'füssen', 'neuschwanstein', 'schwangau'], summary: 'Alp eteğindeki Füssen; masal şatosu Neuschwanstein ile Hohenschwangau’ya açılan konumu ve göllü doğasıyla ünlüdür.', sources: ['Germany.travel — Neuschwanstein / Füssen'] },
  { id: 'heidelberg', name: 'Heidelberg', city: 'Heidelberg', country: 'Almanya', lat: 49.3988, lng: 8.6724, aliases: ['heidelberg'], summary: 'Neckar kıyısındaki Heidelberg; yıkık kızıl kalesi, Almanya’nın en eski üniversitesi, Eski Köprü ve Filozoflar Yolu manzarasıyla romantik bir kenttir.', sources: ['Germany.travel — Heidelberg'] },
  { id: 'dresden', name: 'Dresden', city: 'Dresden', country: 'Almanya', lat: 51.0504, lng: 13.7373, aliases: ['dresden'], summary: 'Elbe kıyısındaki “Elbe Floransası” Dresden; yeniden inşa edilen Frauenkirche, Zwinger sarayı ve Semperoper’le barok sanat kentidir.', sources: ['Germany.travel — Dresden'] },
  { id: 'leipzig', name: 'Leipzig', city: 'Leipzig', country: 'Almanya', lat: 51.3397, lng: 12.3731, aliases: ['leipzig'], summary: 'Müzik ve tarih kenti Leipzig; Bach’ın Thomaskirche’si, pasajları ve Uluslar Savaşı Anıtı ile canlı bir Doğu Almanya merkezidir.', sources: ['Germany.travel — Leipzig'] },
  { id: 'badenbaden', name: 'Baden-Baden', city: 'Baden-Baden', country: 'Almanya', lat: 48.7606, lng: 8.2396, aliases: ['baden-baden', 'baden baden', 'badenbaden'], summary: 'Kara Orman eteğindeki kaplıca kenti Baden-Baden; tarihî termal hamamları, kumarhanesi ve zarif bahçeleriyle klasik bir kür duraktır.', sources: ['Germany.travel — Baden-Baden'] },
  { id: 'freiburg', name: 'Freiburg', city: 'Freiburg', country: 'Almanya', lat: 47.999, lng: 7.8421, aliases: ['freiburg', 'freiburg im breisgau'], summary: 'Kara Orman’ın güneş yüzlü kapısı Freiburg; gotik Münster katedrali, sokaklardan akan Bächle su kanalları ve bağlarıyla bilinir.', sources: ['Germany.travel — Freiburg'] },
  // --- İsviçre & Doğu Fransa ara durakları ---
  { id: 'bern', name: 'Bern', city: 'Bern', country: 'İsviçre', lat: 46.948, lng: 7.4474, aliases: ['bern', 'berne'], summary: 'İsviçre’nin başkenti Bern; Aare Nehri’nin sardığı, arkadlı ortaçağ eski şehri (UNESCO), Zytglogge saat kulesi ve ayı parkıyla bilinir.', sources: ['UNESCO World Heritage List — Old City of Berne', 'MySwitzerland — Bern'] },
  { id: 'cenevre', name: 'Cenevre', city: 'Cenevre', country: 'İsviçre', lat: 46.2044, lng: 6.1432, aliases: ['cenevre', 'geneva', 'geneve', 'genf'], summary: 'Göl kıyısındaki Cenevre; 140 m fışkıran Jet d’Eau’su, eski şehri, BM ve Kızılhaç merkezleriyle uluslararası bir kenttir.', sources: ['MySwitzerland — Geneva'] },
  { id: 'lausanne', name: 'Lausanne', city: 'Lausanne', country: 'İsviçre', lat: 46.5197, lng: 6.6323, aliases: ['lausanne'], summary: 'Léman Gölü’ne yamaçtan bakan Lausanne; gotik katedrali, Olimpiyat Müzesi ve Ouchy sahiliyle bilinir.', sources: ['MySwitzerland — Lausanne'] },
  { id: 'montreux', name: 'Montreux', city: 'Montreux', country: 'İsviçre', lat: 46.4312, lng: 6.9107, aliases: ['montreux'], summary: 'Léman kıyısındaki Montreux; göl üstündeki Chillon Şatosu, çiçekli sahil promenadı ve ünlü caz festivaliyle bilinir.', sources: ['MySwitzerland — Montreux'] },
  { id: 'lugano', name: 'Lugano', city: 'Lugano', country: 'İsviçre', lat: 46.0037, lng: 8.9511, aliases: ['lugano'], summary: 'İsviçre’nin İtalyan tarafındaki Lugano; palmiyeli göl kıyısı, Monte Brè/San Salvatore manzaraları ve Akdeniz havasıyla bilinir.', sources: ['MySwitzerland — Lugano'] },
  { id: 'strasbourg', name: 'Strasbourg', city: 'Strasbourg', country: 'Fransa', lat: 48.5734, lng: 7.7521, aliases: ['strasbourg', 'strazburg'], summary: 'Alsas’ın başkenti Strasbourg; pembe kumtaşı katedrali, kanallarla çevrili Petite France mahallesi (UNESCO) ve Avrupa Parlamentosu’yla bilinir.', sources: ['UNESCO World Heritage List — Strasbourg, Grande-Île and Neustadt'] },
  { id: 'colmar', name: 'Colmar', city: 'Colmar', country: 'Fransa', lat: 48.0794, lng: 7.3585, aliases: ['colmar'], summary: 'Alsas Şarap Yolu’nun incisi Colmar; kanallı “Küçük Venedik”i ve yarım ahşap renkli evleriyle masalsı bir kasabadır.', sources: ['France.fr — Colmar'] },
  { id: 'dijon', name: 'Dijon', city: 'Dijon', country: 'Fransa', lat: 47.322, lng: 5.0415, aliases: ['dijon'], summary: 'Burgonya’nın başkenti Dijon; Dük Sarayı, renkli çatılı tarihî evleri, hardalı ve baykuş rotasıyla bilinen bir şarap-gastronomi kentidir.', sources: ['France.fr — Dijon'] },
  { id: 'annecy', name: 'Annecy', city: 'Annecy', country: 'Fransa', lat: 45.8992, lng: 6.1294, aliases: ['annecy'], summary: '“Alplerin Venedik’i” Annecy; kanalları, göl ortasındaki Palais de l’Isle’i ve turkuaz gölüyle şirin bir dağ kasabasıdır.', sources: ['France.fr — Annecy'] },
  { id: 'avignon', name: 'Avignon', city: 'Avignon', country: 'Fransa', lat: 43.9493, lng: 4.8055, aliases: ['avignon'], summary: 'Provence’ın Avignon’u; papaların 14. yy’da yaşadığı devasa Papalık Sarayı ve şarkıya konu Pont d’Avignon köprüsüyle UNESCO korumalıdır.', sources: ['UNESCO World Heritage List — Historic Centre of Avignon'] },
  { id: 'aix', name: 'Aix-en-Provence', city: 'Aix-en-Provence', country: 'Fransa', lat: 43.5297, lng: 5.4474, aliases: ['aix', 'aix-en-provence', 'aix en provence'], summary: 'Çeşmeler kenti Aix-en-Provence; ağaçlı Cours Mirabeau bulvarı, pazarları ve ressam Cézanne’ın izleriyle zarif bir Provence kentidir.', sources: ['France.fr — Aix-en-Provence'] },
